...
function submitHandler(event) {
  event.preventDefault();
      ...
      console.log(name,email,password,confirmPassword,dateOfBirth)
        ...
        <div className="border border-gray-300 w-xl p-6 m-auto rounded-xl shadow-xl">
            <h2 className="mb-6 text-center text-2xl font-bold text-gray-800">Sign Up</h2>
                ...
                <div className="mt-6">
                    ...
                    <input type="text" placeholder="Enter your name" className="w-full mt-1 px-4 py-2 border rounded-xl shadow-sm focus:ring-2 focus:ring-blue-400 focus:outline-none border-gray-300" onChange={(e) => setName(e.target.value)} />
                </div>
                <div className="mt-6">
                ...
                <div className="mt-6">
                    ...
                    <input type="date" id="dob"
                        className="w-full px-4 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none border-gray-300" onChange={(e) => setDateOfBirth(e.target.value)} />
                </div>
                <div className="mt-6">
                ...
                <div className="mt-6">
                    ...
                    <input type="password" id="confirm" placeholder="Confirm your password"
                        className="w-full px-4 py-2 text-sm border rounded-lg focus:ring-2 focus:ring-blue-500 focus:outline-none border-gray-300" onChange={(e) => setConfirmPassword(e.target.value)} />
                </div> 
                <div className="mt-8">
